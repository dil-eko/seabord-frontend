      ...
      <body className="min-h-dvh bg-background text-foreground font-sans antialiased">
        ...
        <footer className="border-t mt-12">
          <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-3 gap-8 text-sm">
            ...
            <section>
              <h2 className="text-xs font-semibold tracking-wide uppercase text-foreground/70 mb-3">
                Quick Links
              </h2>
        ...
        {/* ✅ Cookie Banner her zaman footer’dan hemen sonra */}
        <CookieBanner />
      </body>
    </html>
  );
