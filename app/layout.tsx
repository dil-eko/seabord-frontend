  ...
  return (
    <html lang="en">
      <body className="min-h-dvh bg-white text-gray-900">
        <a href="#main" className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 bg-white border rounded px-3 py-1 text-sm">
          Skip to content
        </a>
          ...
          <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-3 gap-8 text-sm">
            <section>
              ...
              <ul className="space-y-2">
                <li><Link className="hover:underline" href="https://example.org" target="_blank" rel="noreferrer">Example Foundation</Link></li>
                <li><Link className="hover:underline" href="https://example.edu" target="_blank" rel="noreferrer">Example University</Link></li>
              </ul>
            </section>
            <section>
