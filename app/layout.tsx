        ...
        <header className="sticky top-0 z-40 bg-background/90 backdrop-blur border-b">
          <nav className="max-w-7xl mx-auto px-4 h-14 flex items-center gap-6">
            <Link href="/" className="flex items-center gap-2" aria-label="Seabord home">
              ...
              <img src="/brand/seabord-wordmark-light.png" alt="" className="h-12 w-auto brand-light" />
              <img src="/brand/seabord-wordmark-dark.png" alt="" className="h-12 w-auto brand-dark" />
            </Link>
